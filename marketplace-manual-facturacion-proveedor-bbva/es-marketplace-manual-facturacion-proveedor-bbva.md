...
![](RackMultipart20211217-4-yfmrzb_html_a1b2237f214300d1.png)
...
![](RackMultipart20211217-4-yfmrzb_html_14fb322d73e07d1e.png)
...
![](RackMultipart20211217-4-yfmrzb_html_c3043c154d9edcc.png)
...
![](RackMultipart20211217-4-yfmrzb_html_2d4de3d0824143e1.png)
...
![](RackMultipart20211217-4-yfmrzb_html_7b6d6324635e2dab.png)
...
![](RackMultipart20211217-4-yfmrzb_html_1e4c9f7b330fb08a.png)
...
Al igual que ocurre actualmente con los pedidos de productos, los pedidos de servicios podrán ser facturables electrónicamente o no, según se indique en el flujo del pedido (iconos de la cabecera del pedido).
...
Debajo de los datos de factura, se mostrarán los datos del comprador y del vendedor.
...
Una vez que hemos terminado de incluir los datos de la línea, añadimos la línea a la factura. Y la factura queda como sigue:
...
![](RackMultipart20211217-4-yfmrzb_html_e8da6cd6dc2b174.png)
...
Una vez seleccionada la factura a rectificar, pulsamos el botón **rectificar**.
...
Cuando hayamos revisado y cumplimentado todos los campos de la factura, podremos firmar la factura y posteriormente enviarla.
...
Si es necesario, vamos a tener la posibilidad de crear facturas rectificativas de facturas financieras. Dichas facturas las crearemos sobre facturas que se encuentren en estado Aceptadas o Rectificadas.
...
Si la factura original tiene más líneas de las que necesitamos rectificar podemos eliminarla de nuestra factura.
...
En la cabecera de la pantalla, visualizará los siguientes datos:
...
![](RackMultipart20211217-4-yfmrzb_html_9f24fd9a1d597a0c.png)
...
![](RackMultipart20211217-4-yfmrzb_html_38c0f690897d249f.png)
...
![](RackMultipart20211217-4-yfmrzb_html_41ea4427ae7f6d51.png)
...
En el momento en el que pulsemos en el botón **Duplicar** , nos aparece el duplicado de esa factura, en estado borrador, que deberá ser firmada. Una vez firmada la factura duplicada, podremos realizar su envío al comprador.
...
En cualquier caso, una vez pulsado el botón **facturar** , Marketplace nos llevará a la pantalla para elegir las recepciones pendientes de facturar para el pedido. El procedimiento de facturación con referencia a pedido recibido está explicado en el apartado 2.2 de este mismo manual.
...
Una vez que hayamos aplicado el cambio de moneda, podremos volver a los valores del pedido, pulsando el botón modificar de la factura (siempre que el estado del documento lo permita) y posteriormente seleccionar en la desplegable moneda, la moneda inicial del pedido.
...
Una vez que seleccionamos la o las líneas y modificamos (en el caso que corresponda) la cantidad a facturar, pulsamos **facturar selección** y Marketplace nos llevará al formulario de pre-factura en el que tendremos cumplimentar los datos obligatorios, los demás datos los hereda del contenido del pedido.
...
En el asistente de facturación Crear **factura** , también encontraremos la opción **Rectificar Factura** desde donde podrá rectificar una pre-factura realizada con referencia a pedido no recibido, tal y como explicamos en el apartado 4.1.2

Al pulsar esta opción, se mostrará la página **Rectificar Factura** , con 2 opciones disponibles para emitir facturas de este tipo:

![](RackMultipart20211217-4-yfmrzb_html_23085852928b88ae.png)

  1. En el campo Nº Factura, se deberá indicar el número de factura a rectificar y a continuación se deberá pulsar el botón **Rectificar Factura**.
  2. Pulsando el botón **Ver Facturas Rectificables** , que permitirá acceder al listado de facturas susceptibles a rectificar. En este listado, se visualizarán tanto las facturas ordinarias enviadas con referencia a pedido, como aquellas facturas que hayan sido creadas y enviadas al comprador sin referencia a pedido.

Al seleccionar la pre-factura a rectificar, pulsaremos el botón **Rectificar** y Marketplace nos llevará al formulario de pre-factura rectificativa en el que se visualizarán los datos de la pre-factura de referencia. Además, podrá añadir los datos de cabecera del nuevo documento.

![](RackMultipart20211217-4-yfmrzb_html_12cfadfa2ff5f8c2.png)

En este tipo de documento, las cantidades e importes de las líneas son en negativo. A nivel de línea solo podremos modificar la cantidad a rectificar, indicándola siempre en negativo (-) y sin exceder la cantidad de la factura original que vamos a rectificar.

![](RackMultipart20211217-4-yfmrzb_html_b6bbf06b27bab2d2.png)

Es importante recordar que debemos eliminar las líneas que no vayamos a rectificar, seleccionándolas y pulsando el botón **eliminar**.

En el detalle de la pre-factura tendremos que definir los datos del documento. Si tenemos que cambiar la moneda de la pre-factura rectificativa solo podremos cambiarla a la moneda de la factura original que se la que aparece por defecto (que puede coincidir con la moneda del pedido, como es el caso del pantallazo).

![](RackMultipart20211217-4-yfmrzb_html_4b1d2ee3b047637a.png)

Así como también, debemos siempre indicar el motivo de la rectificación.

![](RackMultipart20211217-4-yfmrzb_html_c88ea49e864d07f8.png)

Si la pre-factura rectificativa es aceptada nuestra pre-factura original pasa a estado rectificada y no puede ser anulada; si la FR se anula, la pre-factura original se devuelve al estado Aceptada.

###  6.1.6. Identificación de las pre-facturas en Marketplace

En Marketplace veremos siempre identificados los documentos emitidos como pre-facturas, bien sea, en el detalle de la factura:

![](RackMultipart20211217-4-yfmrzb_html_f5cf2f46198bac7e.png)

O en el listado de facturas:

![](RackMultipart20211217-4-yfmrzb_html_bb5328731a58cbd9.png)

###  6.1.7. Vista previa de las pre-facturas en Marketplace

En las pre-facturas podremos visualizar los datos (razón social, CIF, domicilio fiscal) de la sociedad que ha realizado el pedido. En la pestaña **Información** , podrá visualizar la dirección de facturación del pedido en el apartado&quot; Dirección de entrega de facturas&quot;. Además del contenido a facturar reflejado la pestaña **línea** de la pre-factura.

![](RackMultipart20211217-4-yfmrzb_html_2c7f38fa77f6e46c.png)

Toda la información se visualizará tanto en la pantalla de Marketplace como en el documento PDF de la pre- factura que podrá descargar en **generar pdf** :

![](RackMultipart20211217-4-yfmrzb_html_e5c8cb523311f175.png)

###  6.2. Facturación Legal proveedores de México

El proceso de facturación electrónica legal en México debe cumplir las especificaciones definidas por el SAT, administración tributaria del Gobierno mexicano. El formato de factura definido por la autoridad mexicana es el formato CFDi en su versión 3.2 y a partir del 1 de julio de 2017 la versión 3.3.

**NOTA: A partir del 1 de Julio de 2017 entra en vigor el formato CFD 3.3, y en Marketplace se podrán gestionar facturas con CFDi versión 3.2 y 3.3 hasta el 1 de diciembre del 2017 que solo quedará en uso la versión de CFDi 3.3.**

La facturación podrá ser con referencia a pedido electrónico publicado en Marketplace. Este pedido podrá tener o no recepciones. Al igual podrá tener factura legal o no. En el caso de no requerir factura legal, la facturación del pedido se realizará a través de las pre-facturas tal como se ha mostrado en el punto 2.6 de este manual. También podrán emitirse facturas financieras, es decir, sin referencia a pedido e igualmente se permitirá la emisión de facturas legales a proveedores extranjeros.

Cuando se elabora una factura legal, en Marketplace se construirá un documento en el formato requerido cuando creemos la factura. Deberemos respetar la normativa legal, por lo que esa factura debe ser sellada por el proveedor y timbrada por un Proveedor Autorizado de Certificación (PAC) y registrada y autorizada en el propio SAT. Para ello nos descargaremos la factura en formato CFDi de Marketplace y enviaremos esa factura al PAC que tengamos contratado. Una vez que el PAC le devuelva sellada y timbrada CFDi, la subiremos de nuevo a Marketplace. También tendremos la posibilidad de cargar el CFDi generado desde sistema externo (solo para proveedores mexicanos).

En Marketplace, cuando realicemos la subida de una factura timbrada (en formato CFDi), se validará la información que incluye comparándola con la generada previamente extraída del pedido (Del pedido para pedidos sin recepción o de las aceptaciones / recepciones en el caso de pedidos con recepción), así como que se ha incluido la información del complemento Timbrado Digital Electrónico. Si se detecta alguna modificación se le mostrará un error al proveedor de manera que no pueda enviarla y sepa que debe modificarla y volver a subirla.

La gestión del flujo de la factura posteriormente seguirá siendo la misma que hasta ahora: borrador, firmada, Enviando, Enviada, En proceso, aceptada… etc. Para más detalle ver el gráfico de ciclo de estados completo. El ciclo de estados que seguirá una factura legal mexicana será:

![](RackMultipart20211217-4-yfmrzb_html_b9d7ab8063bb7b89.png)

###  6.2.1. Facturación con referencia a pedido (logística)

La facturación con referencia a pedido, se hará como se ha explicado anteriormente en este manual, pudiendo ser de un pedido recibido o un pedido sin recepciones. Para los proveedores mexicanos no está disponible la opción para emitir duplicados. También aplicará en estas facturas la limitación de poder añadir 474 líneas como máximo en cada documento de factura.

Están disponibles dos modos de generar las facturas, que denominaremos Modelo Fijo y modelo Libre, solo para facturas de proveedores locales.

El **Modelo Fijo** es aquel en el que generaremos la factura con los datos de Adquira Marketplace. Posteriormente, una vez introducida toda la información, se descarga un documento CFDi con los datos introducidos. Ese CFDi será sellado y timbrado por el PAC que tenga contratado el proveedor. Una vez timbrado ese documento CFDi será anexado a la factura generada en Adquira. Tal y como se muestra en la figura:

![](RackMultipart20211217-4-yfmrzb_html_41c4e45558078b27.png)

El **Modelo Libre** es ligeramente diferente. Aunque crearemos la factura en Marketplace introduciendo todos los datos, el CFDi que llevaremos a timbrar al PAC no es el generado por Marketplace sino el generado por un sistema propio (o por el propio PAC), es decir, un sistema externo a Marketplace. Este documento timbrado es anexado a la factura creada en Adquira Marketplace. La figura siguiente nos muestra este caso:

![](RackMultipart20211217-4-yfmrzb_html_94641b5b4537111.png)

Marketplace está preparado para gestionar la obtención del certificado desde el SAT, en el caso de que el certificado incluido por el PAC no esté dado de alta en el sistema.

###  6.2.1.1. Creación de factura (proveedor local)

En el caso de que el pedido requiera factura legal vendrá indicado por el icono de facturación:

![](RackMultipart20211217-4-yfmrzb_html_465a39c958aca5fe.png)

Podremos crear facturas de forma individual y también podremos crear facturas de forma masiva para pedidos recibidos a través del fichero Excel, tal como se explica en el punto 2.6 de este manual, cumplimentando los nuevos campos del Excel: Régimen fiscal y Referencia de pago.

**Creación de factura**

Para crear facturas accederemos a la opción **crear factura:**

![](RackMultipart20211217-4-yfmrzb_html_c5fb508e1bc38e3a.png)

Una vez que seleccionamos el pedido y marcamos las posiciones a incluir en la factura, os el botón **facturar selección** para acceder al formulario de factura, donde tendremos que informar los datos de la factura.

**Cabecera de la Factura**

En la cabecera nos encontraremos los campos: Nº de serie y Nº de folio. El campo número de factura se formará de concatenar la serie y el folio con un máximo de 16 caracteres (siempre en mayúsculas). En caso de que la referencia de factura resultante exceda de los 16 caracteres o esté vacía, se dejará la referencia en blanco. Si el proveedor no lo rellena se mostrará, al igual que se hace ahora, un mensaje de error indicando que la referencia es obligatoria

![](RackMultipart20211217-4-yfmrzb_html_da52a64aeddfc24f.png)

- **Régimen fiscal** , desplegable en el que podremos seleccionar el valor correspondiente, al régimen fiscal a aplicar a la factura.
- **Vía de pago** , en este desplegable tendremos disponible para emitir facturas a Bancomer, la opción &quot;Transferencia electrónica de fondos&quot;
- **Lugar de expedición de la factura** , indicaremos el código postal del lugar de expedición del comprobante, debe corresponder con una clave de código postal incluida en el catálogo (5 dígitos).
- **Anticipo** , en este campo podremos informar la referencia a un anticipo, si corresponde. Es un campo opcional y de texto libre, alfanumérico de máximo 18 caracteres.
- **Referencia de pago** : podremos incluir el valor correspondiente entre 7 y 20 caracteres.
- **Pago Periodificado** , es un indicador que al marcarlo permite a los informar que el pago de esta factura se periodificará, es decir si se fraccionará el pago de dicha factura. Si creamos una Factura rectificativa este dato se heredará de la factura original y no podremos modificarlo.
- **Factura con factura rectificativa / nota de crédito asociada:** si lo marcamos nos permitirá indicar si la factura que estamos creando llevará asociada alguna factura rectificativa, de manera que en el sistema del BBVA (GPS) se pueda gestionar correctamente, es decir, se bloqueará para el pago hasta que se registre la factura rectificativa correspondiente.
- **Tasa de conversión** : Este campo aparecerá en la creación de factura cuando la divisa del pedido sea distinta al Peso Mexicano. En este campo aparecerá la tasa de cambio que llega desde GPS en el pedido, pero el campo será modificable en el momento de creación de la factura, sin embargo, no se puede cambiar la moneda.

Además, tendremos disponible la opción e indicar los datos de pago para la factura:

![](RackMultipart20211217-4-yfmrzb_html_662eca0d46106f17.png)

- **Receptor alternativo de pago** , en este campo podremos indicar el código RFC de otra empresa para que reciba el pago de la factura.
- **Cuenta de abono** , nos permitirá informar los 4 últimos dígitos de la cuenta en la que se nos abona la factura.

Es importante tener en cuenta que, si en la cabecera de la factura hemos cumplimentado el campo referencia de pago, no podremos incluir información ni en el campo Receptor alternativo ni en la cuenta de Abono, ya que son campos excluyentes entre sí. Es decir que, o indicamos uno u otro, pero no ambos a la vez. Para las sociedades de México, será obligatorio rellenar la cuenta de abono o la referencia de pago.

Como ya sabemos, en una factura con referencia a pedido, no podremos incluir más de 474 posiciones. Por lo que además de cumplimentar los datos de la cabecera del documento, tendremos que verificar las líneas de la factura y podremos modificar los impuestos asociados a las líneas de la factura y añadir alguna retención.

**Líneas de Factura**

![](RackMultipart20211217-4-yfmrzb_html_fbbba23b23955d61.png)

En las líneas de la factura, además de la información incluida desde el pedido, tendremos los siguientes campos que podremos informar pulsando el botón **editar** :

- **Clave de producto/servicio:** podremos informar la clave del producto o del servicio descrito, utilizaremos las claves de los diversos productos o servicios, que se encuentran incluidas en el catálogo publicado en el Portal del SAT, cuando los conceptos que se registren por sus actividades correspondan a estos.

En el caso de que la clave de un producto o servicio no se encuentre en el catálogo, debemos informar 01010101 (No existe en el catálogo) o podremos dejar el campo en blanco y Marketplace por defecto informará el valor como si no existiese en el catálogo.

- **Numero Pedimento:** indicaremos el número del pedimento correspondiente a la importación del bien El cual se integra de izquierda a derecha de la siguiente manera:
...
Para validar la estructura de este campo puede consultar la documentación técnica publicada en el Portal del SAT.

Ejemplo: NumeroPedimento= 10 47 3807 8003832

![](RackMultipart20211217-4-yfmrzb_html_18eb06de52f5b89c.png)

Para incluir esta información, seleccionaremos la línea correspondiente y pulsamos el botón **editar** :

![](RackMultipart20211217-4-yfmrzb_html_e475447b8aa970a8.png)

Además de informar los campos descritos anteriormente , en este punto tambien podremos **editar** y/o **añadir** impuestos y/o retenciones si corresponde.

![](RackMultipart20211217-4-yfmrzb_html_1f6d82fffdc50afe.png)

![](RackMultipart20211217-4-yfmrzb_html_ffa4ce41e3e65600.png)

Una vez que hayamos rellenado toda la información de la línea pulsaremos el botón **guardar cambios**.

![](RackMultipart20211217-4-yfmrzb_html_e524a0ae86452904.png)

De igual forma, en la pestaña líneas disponemos del enlace **Actualización masiva** , que nos permitirá modificar o añadir impuestos y retenciones para una o todas las líneas de la factura. Tal como se explica en el apartado 2.2 de este mismo manual.

![](RackMultipart20211217-4-yfmrzb_html_c5f2afe0a7b39f80.png)

Una vez guardada la factura, podremos adjuntar ficheros a la factura electrónica legal, para ello dispondremos del botón **Añadir** en la pestaña **Adjuntos** de la factura. Al pulsarlo nos permitirá seleccionar el fichero almacenado en nuestro ordenador (máximo 2Mb por fichero) y proseguir con la gestión de la factura.

En ambos modelos se requerirá obligatoriamente anexar un documento antes de enviarse la factura. Este documento debería corresponder con la representación impresa del CFDi.

![](RackMultipart20211217-4-yfmrzb_html_aba713861187876d.png)

###  6.2.1.1.1. Modelo fijo

Se creará la factura en Marketplace, al guardar la factura, la plataforma creará el documento XML de factura asociado.

Posteriormente procederemos a generar un documento CFDi. Le denominaremos CFDI&#39; ya que aún faltará ser sellado y timbrado por un PAC autorizado.

Al tratarse de un documento legal que debe ser firmado fuera de la plataforma, al proveedor no le aparecerá la opción de firmar factura. Solo podrá guardar, eliminar y descargarse el documento.

Para descargarse el documento legal podemos hacerlo desde la propia factura, pulsando el desplegable Acciones/Descargar (para facturas legales de México estará disponible en el estado Borrador).

![](RackMultipart20211217-4-yfmrzb_html_4e9ae6fb38044a41.png)

También podremos hacerlo de forma masiva desde el listado facturas emitidas que se muestra en la pantalla al seleccionar el apartado **Facturas** la opción **consulta y gestión**. Seleccionando las facturas de las que necesitamos obtener el fichero y luego pulsando el botón **descargar**.

![](RackMultipart20211217-4-yfmrzb_html_b2b96bcdd6c5fbaa.png)

Obtendremos una carpeta comprimida con los documentos CFDI&#39; generados, uno por cada factura seleccionada. Podremos seleccionar hasta 10 facturas por cada descarga. Al realizar esta descarga en el estado borrador, solo se generará el documento legal y no el PDF, de forma de facilitar la gestión con el PAC.

![](RackMultipart20211217-4-yfmrzb_html_70c4d5845699c8b2.png)

![](RackMultipart20211217-4-yfmrzb_html_42c16e371f23763b.png)

Una vez que hemos descargado los documentos CFDI&#39;, deberemos entregarlos al PAC que tengamos contratado para sellarlo y timbrarlo. Una vez esta operación se realice el documento incluirá el complemento TimbreFiscalDigital.

El siguiente paso será el de subirlo a Marketplace para asociarlo a la factura generada previamente, de manera de poder realizar el envío de la factura.

Podremos hacerlo de forma individual, accediendo al formulario de la factura y en la pestaña **adjuntos** de la factura con el botón **Cargar documento legal** :

![](RackMultipart20211217-4-yfmrzb_html_7258288166bdd85e.png)

Seleccionamos el documento correspondiente, el CFDI&#39; que vamos a cargar debe contener los mismos datos que la factura creada en Marketplace:

![](RackMultipart20211217-4-yfmrzb_html_5158ad8534380c8d.png)

Pulsamos el botón Enviar para cargar el documento a la factura:

![](RackMultipart20211217-4-yfmrzb_html_29b3e25cdc5a7846.png)

Una vez cargado, el documento la factura pasará a estado firmada y nos aparecerá el botón **enviar**.

![](RackMultipart20211217-4-yfmrzb_html_53bfae82604ba795.png)

###  6.2.1.1.2. Modelo Libre

La creación de la factura en Marketplace es igual a la descrita anteriormente, lo único que cambia en este proceso es la generación del CFDi, que será generado en un sistema distinto a Marketplace.

Una vez guardada factura podremos adjuntar el CFDi ya timbrado a la factura que se encuentra en estado borrador en Marketplace.

![](RackMultipart20211217-4-yfmrzb_html_192320c71a789ddd.png)

Al cargarse el documento se realizarán una serie de validaciones del contenido del CFDi que permitan continuar con el envío de la factura. Entre dichas validaciones estará el número de factura, importe total, de impuestos…etc. Además de realizarse una validación del esquema y formato CFDi, verificando entre otras cosas que el código de vía de pago incluido sea válido. En ningún caso se validará el número de líneas de factura. Esta comprobación se realiza en la factura creada en Marketplace y no se podrán incluir más de 474 posiciones de factura al ser una factura con referencia a pedido. Para la verificación de los importes se ha establecido una tolerancia de 1 peso tanto al alza como a la baja.

###  6.2.1.2. Proveedor extranjero

Para las sociedades de BBVA en México, se permitirá crear facturas legales logísticas a proveedores extranjeros. Estas facturas, aunque serán legales tendrán el funcionamiento de las pre-facturas. Si el proveedor tiene sede en México se gestionará como factura de proveedor nacional.

Al crear la factura, podremos observar que no se mostrarán los campos Número de serie, ni número de folio, ya que solo se informará un número de factura. En la cabecera de la factura aparecerán también los campos que se visualizan en las facturas logísticas para proveedores nacionales: anticipo, cuenta de abono, indicador de periodificación y factor de conversión (siempre y cuando el pedido esté en una moneda distinta al peso mexicano). Sin embargo, al ser con referencia a pedido podremos incluir máximo 474 posiciones de factura.

![](RackMultipart20211217-4-yfmrzb_html_a21577fc2f44645e.png)

Posteriormente se podrán modificar las líneas de la factura si corresponde:

![](RackMultipart20211217-4-yfmrzb_html_359123441a53b02b.png)

Si el proveedor es extranjero, es decir, no tiene sede en México, la factura no requerirá de anexo del CFDi. Sin embargo, tendrá la obligación de adjuntar un fichero: el documento legal de la factura, en el apartado de Adjuntos de la factura.

![](RackMultipart20211217-4-yfmrzb_html_4a48f8b0c436cddb.png)

Una vez cumplimentados todos los datos de la factura debemos guardar la factura, proceder a la firma digital de la misma y posteriormente al envío.

###  6.2.1.3. Carga masiva de facturas

Podremos realizar cargas masivas de facturas logísticas desde un fichero Excel, accediendo desde la opción **cargar fichero** del apartado **crear factura**.

![](RackMultipart20211217-4-yfmrzb_html_6554e9c0650b1fe4.png)

Una vez seleccionada la opción **Carga masiva de facturas** , podremos descargar la plantilla para elaborar correctamente nuestro fichero de carga.

![](RackMultipart20211217-4-yfmrzb_html_6bb2b2de57648e25.png)

En dicha plantilla encontraremos toda la información necesaria para incluir los datos correspondientes (valor, formato, si es obligatorio o no), de manera que podamos cargar las facturas en Marketplace, también encontraremos una pestaña de ejemplo para proveedores mexicanos y extranjeros que vayamos a crear facturas a BANCOMER.

La siguiente imagen nos muestra un ejemplo del contenido de la plantilla:

![](RackMultipart20211217-4-yfmrzb_html_741cb3f271a1c521.png)

Sin embargo, para disponer de la información completa, debemos descargarnos la plantilla de Marketplace y revisarla minuciosamente para elaborar nuestro fichero. Debemos tener en cuenta si somos proveedor local o extranjero para cumplimentar los campos correctos según cada caso. Y que en cada factura solo podremos incluir un máximo de 474 líneas.

Cuando tengamos el fichero creado podremos subirlo a Marketplace mediante el botón cargar fichero; podremos revisar el resultado de la carga la opción **ficheros cargados** del apartado **facturas**.

![](RackMultipart20211217-4-yfmrzb_html_894113364c9fd92b.png)

###  6.2.1.4. Factura rectificativa financiera con referencia una factura logística

Para la gestión de los descuentos en factura se incorporará la posibilidad de crear Facturas Rectificativas Financieras que hagan referencia a facturas logísticas, de manera que no tenga necesariamente que existir un movimiento de mercancía para realizar dicha gestión. Pare ello utilizaremos la opción, **Rectificar factura** del apartado **Crear factura**.

**NOTA** : Las facturas rectificativas logísticas seguirán habilitadas para facturar devoluciones tal como se explica en el punto 4.1.1 de este manual

![](RackMultipart20211217-4-yfmrzb_html_bd7bbcd2d8ef4119.png)

Seleccionamos la factura sobre la que vamos a realizar la rectificativa y pulsamos el botón rectificar factura.

![](RackMultipart20211217-4-yfmrzb_html_2fccd6ff26a026d8.png)

La factura la crearemos cumplimentando los campos de la cabecera del documento:

![](RackMultipart20211217-4-yfmrzb_html_3fd5337e919f6b40.png)

Visualizaremos todos los campos de la factura legal logística, Número de folio, número de serie, Número de Factura, Anticipo, Indicador Pago Periodificado, Indicador de factura rectificativa, régimen fiscal, etc_ **.** _

Además, se añade un nuevo dato **Tipo de Comprobante** que indica el tipo de documento que se va a crear: Ingreso o Egreso, en función de la selección se validará que el importe de la Factura rectificativa sea positivo (ingreso) o negativo (egreso).

![](RackMultipart20211217-4-yfmrzb_html_850a335d5decb64.png)

También debemos cumplimentar el campo comentarios, ya que en este tipo de facturas es obligatorio.

![](RackMultipart20211217-4-yfmrzb_html_385fe8d83670f1b9.png)

Una vez cumplimentados los datos del detalle de la factura debemos modificar las líneas de factura.

![](RackMultipart20211217-4-yfmrzb_html_9ff583526608d0da.png)

![](RackMultipart20211217-4-yfmrzb_html_10f874426b435499.png)

Luego procederemos al anexado de documentos correspondientes, para posteriormente proceder al envío.

###  6.2.2. Facturación financiera para México (sin referencia a pedido)

En el caso de la factura financiera tendremos también disponibles el proceso de creación con Modelo Fijo y con Modelo Libre. Podremos crear las facturas de forma individual accediendo a la opción **Crear factura** y seleccionando **la opción Facturar sin pedido**.

![](RackMultipart20211217-4-yfmrzb_html_494b0d090c6797d.png)

El proceso de creación de factura financiera se explica en el punto 3.1 de este manual. Para estas facturas podremos incluir un máximo de 950 líneas de factura independientemente de si somos proveedor local o extranjero.

###  6.2.2.1. Proveedor local

A continuación, veremos los campos que tendremos que cumplimentar en la elaboración de la factura financiera legal como proveedores mexicanos.

En la cabecera de la factura, además de los campos incluidos en la factura legal con referencia a pedido tales como: serie, folio, vía de pago, régimen fiscal, lugar de expedición de la factura, etc. Se incorporan los campos correspondientes a la factura financiera (tal como se explican en el punto 3.1 de este manual.

Tendremos los campos serie (25 caracteres) y folio (20 caracteres), que se concatenaran en mayúsculas para formar el campo número de factura (máximo 16 caracteres), al igual que en la factura con referencia pedido.

Debemos informar los campos:

- **Código de usuario aprobador** , al igual que en las facturas financieras para España. Se muestra texto de ayuda y es un dato obligatorio de máximo 7 caracteres.
- **Lugar de expedición de la factura** , debemos indicar el código postal del lugar de expedición del comprobante, debe corresponder con una clave de código postal incluida en el catálogo (5 dígitos).
- **Factura provisionada en el ejercicio anterior** , es un indicador que tendremos que marcar si la factura se ha provisionado en el ejercicio anterior).
- **Nº de Contrato y anexo** , tendremos un campo opcional de máximo 13 caracteres, para informar el número de contrato asociado a la factura.

Además, debemos recordar que los campos: referencia de pago, receptor alternativo de pago y cuenta de abono, son campos excluyentes entres si al igual que en las facturas logísticas, por lo que cumplimentaremos solo uno de ellos.

![](RackMultipart20211217-4-yfmrzb_html_deefe65c1cfd554c.png)

Una vez cumplimentada el detalle de la factura, tendremos que crear las líneas, para ello nos encontraremos con los siguientes campos a cumplimentar para cada una de ellas:

![](RackMultipart20211217-4-yfmrzb_html_a188bd13126c7dbd.png)

![](RackMultipart20211217-4-yfmrzb_html_c37e78d6caab3698.png)

Además de indicar la descripción del articulo/servicio, cantidad, unidad y precio. Tendremos que informar el objeto al que imputa la factura al igual que para las facturas financieras de España. Se rellenará un tipo de imputación y su valor asociado.

**Tipo de imputación:** obligatorio, desplegable con 5 valores fijos, con texto de ayuda (en el que se explicarán los tipos de imputación y el formato requerido para los valores de imputación)
...
**Valor de imputación:** obligatorio cuando se haya seleccionado un tipo de imputación, corresponderá al tipo seleccionado en el desplegable anterior y se validará en función de lo seleccionado:

- Si tipo es Centro de coste: Alfanumérico de 10 caracteres, sin caracteres especiales
- Si tipo es Elemento PEP: Alfanumérico de hasta 15 caracteres, no se validará ningún formato especial
- Si tipo es Activo Fijo: Alfanumérico de hasta 12 caracteres, sin caracteres especiales
- Si tipo es Unidad Económica: Numérico de hasta 8 dígitos
- Si tipo es Bursatilización: no se informará valor de imputación, bloqueándose el campo. Este tipo solo es válido para la sociedad MX11 (Bancomer).

Además, se tendremos tres campos adicionales:

- **Cuenta contable** : solo activo (visible en pantalla) y obligatorio si tipo de imputación no es Activo Fijo. Numérico de 8 dígitos
- **Fideicomiso:** solo activo si tipo de imputación es **Bursatilización**. Alfanumérico de 21 caracteres.
- **Número Acreditado** : solo activo si tipo de imputación es **Bursatilización**. Alfanumérico de 20 caracteres.

Si una factura está marcada con el indicador de **factura periodificada** no podríamos seleccionar el tipo de imputación Activo Fijo.

Para informar los datos de la aduana tendremos quecumplimentar el **número del pedimento** correspondiente a la importación del bien. Con el formato siguiente:
...
Luego incluiremos los impuestos y retenciones correspondientes y pulsamos **guardar cambios** , para agregar la línea a nuestra factura.

Una vez hayamos incluido todas las líneas de la factura (nunca más de 950 posiciones), procederemos a adjuntar los documentos necesarios y posteriormente cargaremos el CFDi que cambiará la factura a firmada para finalmente enviarla al sistema del comprador.

###  6.2.2.2. Proveedor Extranjero

Si lo que necesitamos es emitir una factura financiera legal a México, pero somos un proveedor extranjero, el procedimiento es igual al descrito anteriormente, no se requerirá número de serie y folio. En la cabecera, indicaremos el número de factura sin superar los 16 caracteres y siempre en Mayúsculas. Tendremos que indicar el código de usuario aprobador y los campos que correspondan dentro de los opcionales. Las facturas no deben superar las 950 posiciones. También tendremos el bloque de datos de pago que deberemos cumplimentar en el caso correspondiente.

![](RackMultipart20211217-4-yfmrzb_html_8df6c41671d8a1ab.png)

![](RackMultipart20211217-4-yfmrzb_html_238ecada0ac3df27.png)

Para las posiciones de factura indicaremos el objeto a que imputa la factura tal y como se explica en el apartado 3.1 de este mismo manual. Además, las opciones serán las mismas que para el proveedor Local:
...
![](RackMultipart20211217-4-yfmrzb_html_8a75bd83a474d385.png)

Tendremos que recordar que este tipo de facturas funcionará como las pre-facturas, no requerirán adjuntar un CFDi, pero igual que para las facturas de logística tendremos que adjuntar el documento legal de la factura. Tendremos que respetar también el límite de no incluir más de 950 líneas de factura. Luego procederemos a la firma y posteriormente al envío de la factura.

###  6.2.2.3. Carga masiva de facturas

Tanto como proveedores locales como extranjeros, podremos realizar una carga masiva de facturas desde un fichero Excel accediendo desde el apartado **Crear factura** a la opción **cargar fichero** y en tipo de acción seleccionar **Creación masiva de facturas.**

![](RackMultipart20211217-4-yfmrzb_html_6554e9c0650b1fe4.png)

Allí podremos descargar la plantilla, donde encontraremos todos los campos que hacen referencia a los datos a incluir en las facturas de México y además contiene una pestaña con los textos a incluir en la celda de régimen fiscal.

![](RackMultipart20211217-4-yfmrzb_html_79c2744e2e24eb90.png)

![](RackMultipart20211217-4-yfmrzb_html_82e7a63c38e98dda.png)

Una vez subidas, se crearán las facturas en borrador, posteriormente tendremos que anexar el CFDi para poder enviar las facturas. El proceso de carga múltiple de facturas es el descrito en el punto 3.3 de este manual.

###  6.2.2.4. Crear facturas desde un CFDI

Solo proveedores locales tendremos la opción de crear facturas mediante la creación de un borrador de factura extrayendo la información directamente del CFDi. Para ello, se comenzará haciendo una carga del CFDi desde el apartado **Crear factura** accediendo a la opción **cargar fichero** y en tipo de acción seleccionar **Creación de facturas a partir de documentos legales**.

![](RackMultipart20211217-4-yfmrzb_html_1ad21530ef8640e6.png)

![](RackMultipart20211217-4-yfmrzb_html_89a533ae3dc1a01f.png)

Una vez subido el CFDi se leerá toda la información del mismo y se creará la factura con dicha información. Solo se quedará pendiente de rellenar la información específica de GPS que no figura en el CFDi. La factura se creará en estado firmada, para evitar que se modifiquen los datos leídos del CFDi.

![](RackMultipart20211217-4-yfmrzb_html_d4745dc3a4fd3790.png)

Para incluir los datos que faltan, pulsaremos el botón **modificar**. Nos aparecerá el formulario con los campos pendientes de rellenar, permitiéndonos modificarlos y para hacer efectivos los cambios pulsaremos guardar.

Encontraremos dos pestañas:

**Pestaña documento** incluiremos los datos de la cabecera de la factura.

![](RackMultipart20211217-4-yfmrzb_html_aab6c2c940193af7.png)

**Pestaña líneas** , incluiremos los datos específicos de las líneas de factura.

![](RackMultipart20211217-4-yfmrzb_html_acaaef82bb4ad72b.png)

Al pulsar guardar cambios, nos permitirá adjuntar ficheros (si corresponde) para posteriormente realizar el envío de la factura.

![](RackMultipart20211217-4-yfmrzb_html_33a59b78eb4d4292.png)

Al cumplimentar todos los datos de la factura procederemos al envío, desde el botón de acciones.

###  6.3. Validaciones CFDI

Una vez anexado el documento CFDi se validará el contenido del mismo para compararlo con la factura creada a la que se ha asociado. Se realizarán grupo de validaciones que serán de obligatorio cumplimiento y en caso de no cumplirse serán bloqueantes, es decir, darán un error y no se dejará enviar la factura. Entre dichas validaciones estará el importe total, los RFCs… además de realizarse una validación del esquema y formato CFDi. Algunas podemos verlas en la siguiente imagen:

![](RackMultipart20211217-4-yfmrzb_html_d51b48770a91ba29.png)

En las validaciones de importes se establecerá una tolerancia de 1 peso tanto al alza como a la baja.

Si creamos facturas desde **Creación de facturas a partir de documentos legales** (apartado 6.2.2.4 de este manual), a las validaciones debemos añadir que se verificará que en el CFDI no se superen las 950 líneas ya que estamos creando una factura financiera.

###  6.4. Impuestos IEPS

El IEPS es un impuesto indirecto, no lo paga el proveedor, se lo traslada al cliente (Bancomer) incrementando sus tarifas con dicho impuesto. Para materiales o servicios en los que estemos sujetos a IEPS, deberemos generar siempre la factura en Marketplace sin incluir este impuesto (ya que no consta en el desplegable de impuestos) pero dicho impuesto puede ir reflejado en el CFDi.

Aplica solo para determinados bienes / servicios como, por ejemplo:

Telefonía \&gt; rentas y servicios telefónicos sujetos a IEPS, equipamientos no sujetos a IEPS

Comedores \&gt; alimentos y bebidas sujetos a IEPS

Este impuesto puede ir reflejado tanto en facturas logísticas como en facturas financieras.

En los ejemplos a continuación suponemos un IEPS del 10% y un IVA del 16%.

Podremos generar el CFDI de 3 formas diferentes:

**CFDI TIPO 1 (****formato libre generado en sistema externo o formato fijo generado en Adquira Marketplace****)**

Base imponible  **110**  MXN

IVA 16% (calculado sobre 110) = 17,6 MXN

Total impuestos = ** 17,6**  MXN

Total a pagar =  **127,6**  MXN

**CFDI TIPO 2 (****formato libre generado en sistema externo****​) ​**
...
Se detecta que la factura en Marketplace tiene 1 indicador de impuesto y el CFDI tiene 2.

**CFDI TIPO 3 (****formato libre generado en sistema externo **** ​) ​**

​Base imponible  **100**  MXN

IEPS 10% (calculado sobre 100) = 10 MXN

IVA 16% (calculado sobre 110) = 17,6 MXN

Total impuestos =  **27,6**  MXN

Total a pagar =  **127,6**  MXN

Se detecta que la factura en Marketplace tiene 1 indicador de impuesto y el CFDI tiene 2 y que los importes (base imponible, importe impuestos) NO coinciden en Marketplace.

###  6.5. Retenciones Cedulares

Tendremos disponibles para incluir en las facturas las retenciones para México, Impuesto cedular, con los porcentajes: 1%, 2%, 3%, 1,5%, que se reflejará en el CFDi como impuesto local.

![](RackMultipart20211217-4-yfmrzb_html_dbd0fb3f7f0dfe5.png)

###  6.6. Complementos específicos

Algunos proveedores debemos utilizar unas tasas especiales TUA/YR…, si un proveedor tiene que utilizar esas tasas, en Marketplace se generarán como una línea más en la factura no como un impuesto añadido, es decir, el proveedor generará una línea con el importe que corresponda y con su impuesto añadido y si debe aplicar esa tasa especial, creará una línea adicional por cada tasa que deba incluir.

**Ejemplo:**

Línea factura 01: billete de avión 1000 MXN + IVA al 16%.

Línea factura 02: TUA importe x MXN IVA Exento al 0%.

Línea factura 03: YR importe x MXN IVA exento 0%.

**Nota:** En el CFDi podrá incluir estos complementos correspondientes a las tasas.

###  6.7. Fecha de vencimiento

Para las facturas de México no nos aparecerá el campo Fecha de vencimiento de la factura. Internamente se calculará esta fecha, aunque no se muestre. Si no se pudiera calcular, por no disponer del valor de plazo de pago, se rellenará con la fecha del día.

**NOTA:** Las pre-facturas no deben alterar su comportamiento.

##  7. Notificaciones del Sistema

El sistema envía automáticamente una serie de notificaciones a los usuarios a medida que se van gestionando las facturas. Dichas notificaciones se envían a una única dirección de remite que es aquella facilitada a Adquira en el momento de la toma de datos. Si tuviese alguna duda o para realizar cualquier modificación de la misma deberá contacto con nuestro Centro de Atención al Cliente en el número de teléfono 902 424 024 o en la dirección de correo electrónico [atencionclientes@adquira.com](mailto:atencionclientes@adquira.com).
...
###  7.1. Factura electrónica enviada desde Adquira Marketplace

A continuación, vemos la plantilla del correo electrónico que recibiremos al enviar la factura desde Adquira Marketplace:

![](RackMultipart20211217-4-yfmrzb_html_10cf795985ba580a.png)

###  7.2. Aceptación de una factura por su comprador en Adquira Marketplace

A continuación, vemos la plantilla del correo electrónico que recibe el proveedor cuando cuándo el comprador acepta una factura previamente enviada. La factura aparecerá en Adquira Marketplace con el estado &quot;Aceptada&quot;.

![](RackMultipart20211217-4-yfmrzb_html_d1de0a50a2609070.png)

###  7.3. Anulación de una factura electrónica enviada desde Adquira Marketplace

A continuación, vemos la plantilla del correo electrónico que recibe el proveedor cuando cuándo el comprador acepta una factura previamente enviada. La factura aparecerá en Adquira Marketplace con el estado &quot;Anulada&quot;.

![](RackMultipart20211217-4-yfmrzb_html_49f174bbb175a313.png)

###  7.4. Rechazo por el comprador de una factura electrónica en Adquira Marketplace
...
![](RackMultipart20211217-4-yfmrzb_html_1bce2d016d338547.png)

###  7.5. Se ha producido un fallo en el envío de una factura electrónica

A continuación, veremos la plantilla del correo electrónico que recibiremos si la factura se devuelve a Marketplace con un error, generado por el sistema del Comprador:

![](RackMultipart20211217-4-yfmrzb_html_730c859f099736d8.png)

##  8. Atencion al Cliente y Formación

Esperamos que este manual le ayude en el uso de Adquira Marketplace. Puede visitar nuestro apartado de formación dentro de la propia aplicación, donde encontrará material formativo adicional.

[https://mkpes.adquira.com](https://mkpes.adquira.com/)

![](RackMultipart20211217-4-yfmrzb_html_defa38db8e0b74bc.png)

Puede acceder a la página web de Adquira donde encontrará más información acerca de nuestros servicios, así como el acceso directo a Marketplace.

[www.adquira.es](http://www.adquira.es/)

![](RackMultipart20211217-4-yfmrzb_html_7b5236dbcebecf83.png)

No dude en ponerse en contacto con nuestro Centro de Atención al Cliente. Estaremos encantados de poder ayudarle en todo lo que necesite.

Centro de Atención al Cliente

Horario de lunes a viernes de 09:00 a 19:00 horas.

Correo: [atencionclientes@adquira.es](mailto:atencionclientes@adquira.es)

9 ![](RackMultipart20211217-4-yfmrzb_html_4262c9dba007e3f1.png) ![](RackMultipart20211217-4-yfmrzb_html_eab09959817f103f.png) 02 424 024

© Octubre 2019 - Adquira España S.A.

![](RackMultipart20211217-4-yfmrzb_html_152c757f43f92833.png)
